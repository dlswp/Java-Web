...
<%-- 회원 정보를 저장할 HashMap 객체를 <useBean> 액션태그를 이용해 생성한다. --%>
...
<%
	...
	// 회원 정보를 저장하는 MemberBean 객체를 생성한다.
	
	membersList.add(m1);
	membersList.add(m2);
	// 전송된 회원 정보와 자바 코드로 생성한 회원정보를 ArrayList에 저장합니다.
	
	membersMap.put("membersList", membersList);
	// 회원 정보가 저장된 membersList를 memberList라는 key로 HashMap에 저장한다.
%>
<!DOCTYPE html>
<html>
<head>
